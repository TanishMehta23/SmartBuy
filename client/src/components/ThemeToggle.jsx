...
export const ThemeToggle = ({ className = '', size = 'md', align = 'right' }) => {
  ...
  return (
    <div className="relative group inline-flex items-center justify-center">
      ...
      {/* Floating Hover Tooltip positioned to stay within viewport */}
      <div className={`pointer-events-none absolute top-full mt-2 ${tooltipAlignClass} opacity-0 group-hover:opacity-100 transition-all duration-200 z-50 whitespace-nowrap shadow-xl`}>
